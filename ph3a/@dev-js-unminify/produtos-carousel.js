$(document).ready(function() {
    ...
    var brandSlider = $('#carousel-produtos');
        ...
        /* Click on Carousel Goes to Current Position */
        $(document).on('click','.owl-item',function() {
        let carousel_v2 = $('#carousel-produtos').data('owl.carousel').relative($(this).index());
        $('#carousel-produtos').trigger('to.owl.carousel',[carousel_v2,300]);
        });
